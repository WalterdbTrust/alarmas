sap.ui.define([
	...
	return BaseObject.extend("alarmas.model.ListSelector", {
		 ...
		 * @class
		 * @public
		 * @alias alarmas.model.ListSelector
		 */
		 ...
		 * @return {alarmas.model.ListSelector} the list selector object for method chaining
		 * @public
		 */
